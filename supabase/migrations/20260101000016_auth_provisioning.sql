...
BEGIN
  ...
  IF new.email = 'bruvolabs.team@gmail.com' OR new.email = 'admin1@queuecare.local' OR new.email = 'admin2@queuecare.local' OR new.email = 'admin3@queuecare.local' THEN
